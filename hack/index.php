					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="#contact" id="contact-link" class="skel-panels-ignoreHref"><span class="fa fa-envelope">Hack</span></a></li>
							</ul>
						</nav>
...
<form action='file.php' method='post'>
									<div class="6u"><input type="file"  name="file" onchange="PreviewImage();"  id="file" /></div>
									<div class="6u"><img id="uploadPreview" style="width: 100px; height: 100px;" /></div>
								</div>
