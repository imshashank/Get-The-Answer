...
$response = Unirest::post(
  ...
  array(
    "X-Mashape-Authorization" => "3KaaAW2E2jzmfOb5nmZvZ6rcecRvUOOR"
  ),
  array(
...
$link = 'http://api.wolframalpha.com/v2/query?input='.$wolfram_query.'&appid=866XWU-H52X63V8TV&output=json';
